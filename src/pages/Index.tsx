...
import { ArrowRight, MessageSquare, Tag, Users, Code } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button asChild variant="outline" size="lg" className="border-white/30 text-grey hover:bg-white/10">
